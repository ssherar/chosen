...
"""
    ...
    coffee:
      ...
      spec:
        files:
          'spec/chosen-jquery-spec.js': ['spec/chosen-shared-spec.coffee', 'spec/chosen-jquery-spec.coffee']
          'spec/chosen-proto-spec.js': ['spec/chosen-shared-spec.coffee', 'spec/chosen-proto-spec.coffee']
